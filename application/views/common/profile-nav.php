        ...
        <div class="main-wrapper">
            <div class="btn-nav">
                <div class="row m-auto">
                    ...
                    <div class="col-md-8r">
                        <a href="<?=base_url();?>booking/booking_list/1" class="btn-menu btn bg-blue <?=($is_page=="booking_list" || $is_page=='book_user_pets' || $is_page=="book_this_user" || $is_page=="booking_set_dates") ? 'active' : ''; ?>">Booking</a>
                    </div>
                    <div class="col-md-8r">
