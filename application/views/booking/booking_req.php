		...
		<div class="row m-t-10">
            ...
            ?>
				<div class="pic-head bg-greyish">                
                    <div class="row">
                        <div class="col-md-12">
                            <i class="fa fa-book f-25 text-blue"></i> Booking Request
                        </div>
                        <div class="col-md-12 m-t-10">
                            <a href="<?=base_url();?>booking/booking_request/1" class="p-nav b-700 f-14 <?=($bPage==1) ? 'active' : '';?>">Pending</a>
                            <a href="<?=base_url();?>booking/booking_request/2" class="p-nav b-700 f-14 <?=($bPage==2) ? 'active' : '';?>">Approved</a>
                            <a href="<?=base_url();?>booking/booking_request/3" class="p-nav b-700 f-14 <?=($bPage==3) ? 'active' : '';?>">Completed</a>
                            <a href="<?=base_url();?>booking/booking_history/1" class="btn bg-blue-a btn-xs pull-right text-white"><i class="fa fa-history"></i> Booking History</a>
                ...
                <?php if($booking_request){ foreach($booking_request as $bl){ extract($bl);?>
					<div class="col-md-6">
