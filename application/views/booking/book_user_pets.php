...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <section class="content">
	  ...
	  <div class="row m-t-10">
		  ...
		  <div class="col-md-9 m-t-10 bio-wrapper-info p-l-0">
                                ...
                                <div class="row m-t-20">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row m-t-10 bio-pet-grp">
                                            <?php $user_pets = $this->Account_model->get_my_pets_to_sit($id);?>
                ...
                <div class="row m-t-20">
                    <?php 
                        $ndf = json_decode($user_pets[0]['ns_date_from']);
                        $ndt = json_decode($user_pets[0]['ns_date_to']);
                    ...
                    <div class="col-md-6">
                        ...
                        <form onchange="$('.setTimeMsg').html('');" id="setTimeForm">
                            <p class="f-20 b-700 text-orange-d m-b-0">Book  
                            <?=$getName;?>'s Pets</p>
                            ...
                            <div class="row m-t-10">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input value="<?=($cb) ? $bdf[1] : $ndf[1];?>" type="time" class="form-control" name="time_start" id="time_start">
                                </div>
                            </div>
                            <div class="row m-t-10">
                                <div class="col-md-7">
                            ...
                            <div class="row m-t-10">
                                <div class="col-md-12">
                                    <button type="button" class="btn bg-blue text-white col-md-12" onclick="checkDateTime(<?=($cb) ? 2 : 1;?>)"><i class="fa fa-check"></i> 
                                        <?=($cb) ? 'Update My Booking' : 'Book Pets Now';?>
                                    </button>
                                    <?php if($cb){ ?>
                    ...
                    <div class="col-md-6">
                        <p class="f-20 b-700 text-orange-d">Pet's Schedule</p>
                        <p class="f-15 m-b-0 text-center m-t-20">
                            <span class="avIcon bg-skyblue"></span> Need Sitter 
                            <span class="avIcon bg-orange"></span> Your Bookmark
    ...
    <script src="<?=base_url();?>assets/js/initializations/init_bup.js"></script>
  </body>
