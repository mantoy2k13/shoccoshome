                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="acc-img">
                                <?php  
                                if($user_img) { ?>
                                    <img id="img-profile" src="<?=base_url();?>assets/img/profile_pics/<?=$user_img;?>" alt="Profile Image">
                                <?php }else{ ?>
                                    <img id="img-profile" src="<?=base_url();?>assets/img/profile2.png" alt="Profile Image">
                                <?php } ?>
                            
                            <span class="cust-mod-edit-prof" title="Choose image"><i class="fa fa-pen text-white"></i></span>
