...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2019 at 08:38 AM
...
CREATE TABLE `sh_users` (
  ...
  `role` tinyint(1) NOT NULL COMMENT '1 admin, 2 member',
...
INSERT INTO `sh_users` (`id`, `fullname`, `occupation`, `email`, `password`, `mobile_number`, `gender`, `complete_address`, `zip_code`, `user_lat`, `user_lng`, `bio`, `user_img`, `cover_photo`, `cover_pos`, `sitter_availability`, `isAvail`, `is_complete`, `role`, `date_created`) VALUES
(1, 'Dirk Nowitzki', 'Basketball Player', 'test@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', '1234', 'Male', 'Cebu City', '6000', 0.00000000000000, '0.00000000000000', 'I am Extra Ordinary', '', '', '', '', 0, 1, 1, '2019-04-24 06:32:04'),
(2, 'Lebron James', 'Basketball Player', 'tom@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', '1234', 'Male', 'singson', '6000', 10.31025630000000, '123.89946920000000', 'I am Extra Ordinary', '', '', '', '', 0, 1, 0, '2019-05-01 12:48:01'),
(3, 'Kobe Bryant', 'Basketball Player', 'test1@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', '1234', 'Male', 'Cebu City Hall, Dr. Jose P. Rizal Street, Cebu City, Cebu, Philippines', '6001', 10.29287600000000, '123.90163800000005', 'Extra ordinary', '', '', '', '', 0, 1, 0, '2019-05-02 05:10:11');
