...
<?php if($is_page=="mainpage" || $is_page=="booking" || $is_page=="create_booking" || $is_page=="select_and_book" || $is_page=="view_bio" || $is_page=="booking_list" || $is_page=="mail"  || $is_page=="sents" || $is_page=="drafts" || $is_page=="bio"){ ?>
