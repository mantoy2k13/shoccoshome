        ...
        <div class="main-wrapper">
            <div class="btn-nav">
                <div class="row m-auto">
                    ...
                    <div class="col-md-8r">
                        <a href="<?=base_url();?>booking/booking_as_host" class="btn-menu btn bg-blue <?=($is_page=="booking_list" || $is_page=='book_user_pets' || $is_page=="book_this_user" || $is_page=="booking_set_dates" || $is_page=="booking_as_host" || $is_page=="booking_as_guest") ? 'active' : ''; ?>">Booking</a>
                    </div>
                    <div class="col-md-8r">
